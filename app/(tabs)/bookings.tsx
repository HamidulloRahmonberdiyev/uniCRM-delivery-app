      ...
      {TABS.map((tab) => {
        ...
        return (
          ...
          >
            ...
            />
            <Text
              style={[segStyles.tabLabel, isActive && segStyles.tabLabelActive]}
            >
              {tab.label}
            </Text>
            <View
              style={[segStyles.countBg, isActive && segStyles.countBgActive]}
            >
              <Text
                style={[
                  segStyles.countText,
                  isActive && segStyles.countTextActive,
                ]}
              >
                {counts[tab.key]}
              </Text>
...
function SwipeableBookingCard({
  ...
  const wrapperStyle = useAnimatedStyle(() => ({
    ...
    marginBottom:
      cardHeight.value === 220 ? 12 : withTiming(0, { duration: 200 }),
  }));
        ...
        <Animated.View style={[cStyles.card, cardAnimatedStyle]}>
          <View style={cStyles.header}>
            ...
            <View style={cStyles.headerInfo}>
              ...
              <View style={cStyles.meta}>
                ...
                <Text style={cStyles.metaText} numberOfLines={1}>
          ...
          <View style={cStyles.infoSection}>
            ...
            >
              ...
              <Text style={cStyles.infoText} numberOfLines={1}>
                {booking.address}
              </Text>
          ...
          <View style={cStyles.actions}>
            <TouchableOpacity
              style={[
                cStyles.finishBtn,
                actionLoading && cStyles.finishBtnDisabled,
              ]}
              activeOpacity={0.85}
          ...
          <View style={cStyles.swipeHint}>
            <View style={cStyles.swipeBar} />
          </View>
        </Animated.View>
      </GestureDetector>
    </Animated.View>
    ...
    >
      <View style={staticStyles.row}>
        <View
          style={[
            staticStyles.avatar,
            !isDone && { backgroundColor: C.textMuted },
          ]}
        >
        ...
        <View style={staticStyles.info}>
          <Text style={staticStyles.name} numberOfLines={1}>
            {booking.customerName}
          </Text>
          <Text style={staticStyles.address} numberOfLines={1}>
            {booking.address}
          </Text>
        </View>
        <View
          style={[
            ...
            isDone ? staticStyles.doneBadge : staticStyles.cancelBadge,
          ]}
        >
          <Feather
            name={isDone ? "check" : "x"}
            size={11}
            color={isDone ? "#2ECC71" : C.danger}
          />
          <Text
            style={[
      ...
      try {
        ...
        notify.error(
          ...
          error instanceof Error
            ? error.message
            : "Buyurtmaga qaytarish amalga oshmadi",
        );
      } finally {
        setActionId(null);
      }
      ...
      {swipeHintVisible && (
        <Animated.View entering={FadeIn.duration(300)} style={sStyles.hintRow}>
          ...
          <Text style={sStyles.hintText}>
            Chapga — Buyurtmalar · O'ngga — Yetkazildi
          </Text>
        ...
        <Animated.FlatList
          ...
          ListEmptyComponent={
            loading ? (
              ...
              <EmptyBox
                icon="inbox"
                title="Jarayonda buyurtmalar yo'q"
                sub="Band qilingan buyurtmalar shu yerda ko'rinadi"
              />
            )
          }
